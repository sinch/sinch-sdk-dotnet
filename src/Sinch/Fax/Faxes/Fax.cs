...
namespace Sinch.Fax.Faxes
{
    ...
    public class Fax
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append($"  {nameof(CallbackContentType)}: ").Append(CallbackContentType).Append('\n');
            ...
            sb.Append($"  {nameof(ErrorId)}: ").Append(ErrorId).Append('\n');
    ...
    [JsonConverter(typeof(EnumRecordJsonConverter<CallbackContentType>))]
    public record CallbackContentType(string Value) : EnumRecord(Value)
    {
