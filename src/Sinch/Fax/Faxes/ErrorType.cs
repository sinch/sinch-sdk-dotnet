...
{
    /// <summary>
    ///     When you receive a Sinch event from the Fax API notifying you of a failure, it will contain two values that can help you understand what went wrong: an errorCode and a type.
