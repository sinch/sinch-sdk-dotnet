...
{
    /// <summary>
    ///     When you receive an event from the fax API notifying you of a failure, it will contain two values that can help you understand what went wrong: an errorCode and an type.
