...
namespace Sinch.SMS.Batches.Update
{
    ...
    public abstract class UpdateBatchBaseRequest
    {
        ...
        /// <summary>
        ///     Request delivery report events.<br/><br/>
        ...
        ///     Learn how to set a default event destination URL
        ...
        /// <summary>
        ///     The client identifier of a batch message. If set, the identifier will be added in the delivery report event for this batch
        /// </summary>
