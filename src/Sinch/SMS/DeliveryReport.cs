...
namespace Sinch.SMS
{
    ...
    {
        /// <summary>
        /// No delivery report sinch event will be sent.
        /// </summary>
        public static readonly DeliveryReport None = new("none");

        /// <summary>
        /// A single delivery report sinch event will be sent.
        /// </summary>
        public static readonly DeliveryReport Summary = new("summary");

        /// <summary>
        /// A single delivery report sinch event will be sent which includes a list of recipients per delivery status.
        /// </summary>
        public static readonly DeliveryReport Full = new("full");

        /// <summary>
        /// A delivery report sinch event will be sent for each status change of a message.
        /// This could result in a lot of sinch events and should be used with caution for larger batches.
        ...
        /// <summary>
        /// A delivery report sinch event representing the final status of a message will be sent for each recipient.
        /// This will send only one sinch event per recipient, compared to the multiple sinch events sent when using per_recipient.
