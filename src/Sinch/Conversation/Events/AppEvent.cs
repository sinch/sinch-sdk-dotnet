...
namespace Sinch.Conversation.Events
{
    public sealed class AppEvent
    {
        ...
        public AppEvent(ComposingEvent composingEvent) => ComposingEvent = composingEvent;
        ...
        public AppEvent(ComposingEndEvent composingEndEvent) => ComposingEndEvent = composingEndEvent;
        ...
        public AppEvent(CommentReplyEvent commentReplyEvent) => CommentReplyEvent = commentReplyEvent;
        ...
        public AppEvent(AgentJoinedEvent agentJoinedEvent) => AgentJoinedEvent = agentJoinedEvent;
        ...
        public AppEvent(AgentLeftEvent agentLeftEvent) => AgentLeftEvent = agentLeftEvent;
        ...
        public AppEvent(GenericEvent genericEvent) => GenericEvent = genericEvent;
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public CommentReplyEvent? CommentReplyEvent { get; init; }

        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public AgentJoinedEvent? AgentJoinedEvent { get; init; }

        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public AgentLeftEvent? AgentLeftEvent { get; init; }
