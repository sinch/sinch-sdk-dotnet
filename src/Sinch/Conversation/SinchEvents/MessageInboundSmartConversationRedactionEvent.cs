...
{
    /// <summary>
    ///     This Sinch event delivers contact (end-user) messages to the API clients. The content of the message goes through an A.I. analysis and is redacted if required.
    /// </summary>
