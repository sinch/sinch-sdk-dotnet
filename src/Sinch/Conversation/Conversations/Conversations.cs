...
namespace Sinch.Conversation.Conversations
{
    ...
    public interface ISinchConversationConversations
    {
        ...
        Task<ListConversationsResponse> List(CancellationToken cancellationToken = default);
        ...
        /// </summary>
        /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
        /// <returns>An async enumerable of all conversations across all pages.</returns>
        IAsyncEnumerable<Conversation> ListAuto(CancellationToken cancellationToken = default);

        /// <inheritdoc cref="ListAuto(CancellationToken)"/>
        ...
        /// </summary>
        /// <param name="injectMessageRequest">The message to inject.</param>
        /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
        /// <returns>A task representing the asynchronous inject operation.</returns>
        ...
        /// </summary>
        /// <param name="request">The list recent conversations request, including filters and pagination.</param>
        /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
        /// <returns>A paginated list of recent conversations with their last message.</returns>
        Task<ListRecentConversationsResponse> ListRecent(ListRecentConversationsRequest request,
            CancellationToken cancellationToken = default);

        /// <summary>
        ///     This operation lists all recent conversations automatically, ordered by when the most
        ///     recent message was sent for that conversation.
        /// </summary>
        /// <param name="request">The list recent conversations request, including filters and pagination.</param>
        /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
        /// <returns>An async enumerable of all recent conversations across all pages.</returns>
        IAsyncEnumerable<ConversationRecentMessage> ListRecentAuto(ListRecentConversationsRequest request,
            CancellationToken cancellationToken = default);
        ...
        /// </summary>
        /// <param name="injectEventRequest">The event to inject.</param>
        /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
        /// <returns>The inject event response containing the event ID and accepted time.</returns>
    ...
    internal sealed class ConversationsClient : ISinchConversationConversations
    {
        ...
        /// <inheritdoc />
        public Task<ListConversationsResponse> List(CancellationToken cancellationToken = default)
            => List(new ListConversationsRequest(), cancellationToken);

        /// <inheritdoc />
        public IAsyncEnumerable<Conversation> ListAuto(CancellationToken cancellationToken = default)
            => ListAuto(new ListConversationsRequest(), cancellationToken);
        ...
        /// <inheritdoc />
        public Task<ListRecentConversationsResponse> ListRecent(ListRecentConversationsRequest request,
            CancellationToken cancellationToken = default)
        {
            var uri = new Uri(_baseAddress,
                $"v1/projects/{_projectId}/conversations:recent?{Utils.ToSnakeCaseQueryString(request)}");
            _logger?.LogDebug("Listing recent conversations for {project}", _projectId);
            return _http.Value.Send<ListRecentConversationsResponse>(uri, HttpMethod.Get, cancellationToken);
        }

        /// <inheritdoc />
        public async IAsyncEnumerable<ConversationRecentMessage> ListRecentAuto(
            ListRecentConversationsRequest request,
            [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            _logger?.LogDebug("Auto listing recent conversations for {projectId}", _projectId);
            do
            {
                var query = Utils.ToSnakeCaseQueryString(request);
                var uri = new Uri(_baseAddress,
