...
namespace Sinch.Conversation.Conversations.InjectEvent
{
    ...
    {
        [JsonConstructor]
        private InjectEventRequest() { }

        public InjectEventRequest(AppEvent appEvent) => AppEvent = appEvent;

        public InjectEventRequest(ContactEvent contactEvent) => ContactEvent = contactEvent;
        ...
        /// <summary>
        ///     Required. The unique ID of the conversation. This is generated by the system.
        /// </summary>
        [JsonIgnore]
